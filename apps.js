 ...
 */
// 在head 中 加载 必要静态
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/codehole/BlackHoleDrive@formal/css/mdui.css">');
document.write('<link rel="icon" href="//cdn.jsdelivr.net/gh/codehole/BlackHoleDrive/imgs/favicon.ico">');
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/codehole/BlackHoleDrive@formal/css/nexmoe.css">');
...
// markdown支持
document.write('<script src="//cdn.jsdelivr.net/gh/codehole/BlackHoleDrive/js/markdown-it.min.js"></script>');
...
<header class="nexmoe-nav">
	<div class="navSize">
			<a href="/"><img class="avatar" src="https://ae01.alicdn.com/kf/U9efb60b58af2445783bb192b77f947a1Y.jpg"/></a>
			<div class="nav_menu">
				<ul class="menu_ul">
					<li class="menu_li"><a href="http://nuocom.cn/" target="_blank">博客</a></li>
...
function nav(path) {
  ...
  var search_bar = `<div class="mdui-toolbar-spacer"></div>
        <div id="search_bar" class="mdui-textfield mdui-textfield-expandable mdui-float-right ${model.is_search_page ? 'mdui-textfield-expanded' : ''}" style="max-width:${isMobile ? 240 : 360}px">
...
<script src="//cdn.jsdelivr.net/gh/codehole/BlackHoleDrive/js/ace.js"></script>
<script src="//cdn.jsdelivr.net/gh/codehole/BlackHoleDrive/js/ext-language_tools.js"></script>
	`;
  $('#content').html(content);
